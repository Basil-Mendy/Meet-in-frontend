...
export default function ForumHeader({ forum, userRole, onProfilePictureUpdate }) {
    ...
    return (
        <>
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <div
                            ...
                            className={`relative w-14 h-14 md:w-16 md:h-16 rounded-full bg-gray-200 flex items-center justify-center flex-shrink-0 overflow-hidden ${forum?.profile_picture ? 'cursor-pointer hover:opacity-80 transition-opacity' : ''
                                } ${isAdmin && 'hover:ring-2 hover:ring-primary'}`}
                            title={isAdmin ? "Click to view, double-click to edit" : "Click to view full picture"}
                        >
                            ...
                            {/* Upload Hint for Admins */}
                            {isAdmin && forum?.profile_picture && (
                                <div className="absolute inset-0 bg-black bg-opacity-0 hover:bg-opacity-40 flex items-center justify-center rounded-full transition-all flex-shrink-0">
            ...
            {/* Image Viewer Modal */}
            {showImageViewer && forum?.profile_picture && (
                <div
