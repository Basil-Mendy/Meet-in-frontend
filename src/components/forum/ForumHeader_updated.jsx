    ...
    return (
        <div className="w-full bg-white border-b border-gray-200 p-4 md:p-6">
            <div className="flex items-start gap-4">
                {/* Left side: Profile Picture and Back Button */}
                <div className="flex flex-col items-center">
                    ...
                    {/* Back Button - below profile picture */}
                    <button
                        onClick={() => navigate("/dashboard")}
                        className="mt-3 flex items-center gap-1 text-primary font-medium text-xs md:text-sm hover:underline"
                    >
