...
export default function ForumMembers({ forum, userRole }) {
    ...
    useEffect(() => {
        fetchMembers();
        // Clear members notifications when entering this tab
        if (forum?.id) {
            clearTabNotifications(forum.id, "members");
        }
    ...
    const MemberCard = ({ member, isStaff = false }) => (
        <div
            ...
            className={`relative rounded-lg p-4 border shadow-sm hover:shadow-md transition ${isStaff
        ...
        >
            ...
            <div className="flex items-center gap-4 mb-4">
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-primary to-blue-600 flex items-center justify-center text-white text-xl font-bold overflow-hidden flex-shrink-0">
